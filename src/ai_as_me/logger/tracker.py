...
class EventTracker:
    ...
    def log(self, level: str, module: str, event: str, data: Optional[Dict[str, Any]] = None) -> None:
        """Log an event.
    ...
    def rotate_if_needed(self, max_size_mb: int = 10):
        ...
        if size_mb > max_size_mb:
            ...
            # Create new log file
            self.log_file = self.logs_dir / f"events-{datetime.now().strftime('%Y%m%d')}.jsonl"
