...
class ExecutionHistory:
    ...
    def add_execution(self, task_id: str, tool: str, prompt: str, 
                     output: str, success: bool, rating: int = None, 
    ...
    def get_rated_tasks(self, min_rating: int = None, max_rating: int = None) -> List[Dict]:
        """获取有评分的任务"""
        history = self._load_history()
